...
| GR-06 | Tests must be re-run safe (unique circles/tokens, no state pollution) | 2026-08-08 | Coda | Run 1: re-running on the same circle made dedup merge into a previously-resolved concept and broke the contradiction test | Active |
